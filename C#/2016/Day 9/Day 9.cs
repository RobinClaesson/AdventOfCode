...
namespace Day_9
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IO.Output(Decompress(input, false).Length, false);

            IO.Output(DecompressedLengthImproved(input), true);
        ...
        private static string Decompress(string input, bool decompressCompressed)
        {
        ...
        private static long DecompressedLengthImproved(string input)
        {
